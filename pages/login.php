...
<!-- Title Page -->
<section class="flex-c-m p-t-160 p-b-80 p-l-15 p-r-15"
         style="background-image: url(../asset/images/bg-title-page-02.jpg);">
            ...
            <div class="col-lg-12 p-b-30">
                ...
                <form class="wrap-form-reservation size22 m-l-r-auto">
                    ...
                    <div class="wrap-btn-booking flex-c-m m-t-6">
                        ...
                        <br>
                        <!-- Button3 -->
                        <button type="submit" class="btn-outline-primary flex-c-m size13 trans-0-4">
                            Inscription
                        </button>
                    </div>
                </form>
