...
$list = $dbcnx->selectQuery(REQ_TYPE_USER);
$list = $dbcnx->selectQuery(REQ_MODE_REGULATION);
$list = $dbcnx->selectQuery(REQ_STATUS_BOOKING);
$list = $dbcnx->selectQuery(REQ_TYPE_ITEM);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 p-t-30">
                ...
                <div class="blo1">
                    <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                        <a href="blog-detail.php"><img src="../asset/images/blog-01.jpg" alt="IMG-INTRO"></a>
            ...
            <div class="col-md-4 p-t-30">
                ...
                <div class="blo1">
                    <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                        <a href="blog-detail.php"><img src="../asset/images/blog-02.jpg" alt="IMG-INTRO"></a>
            ...
            <div class="col-md-4 p-t-30">
                ...
                <div class="blo1">
                    <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                        <a href="blog-detail.php"><img src="../asset/images/blog-03.jpg" alt="IMG-INTRO"></a>
